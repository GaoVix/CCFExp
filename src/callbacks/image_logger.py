...
class ImageLogger(Callback):
    ...
    def on_validation_epoch_end(self, trainer: "pl.Trainer", pl_module: "pl.LightningModule", stage='val') -> None:
        ...
        if pl_module.global_rank == 0:
            ...
            # if pl_module.hparams.label_mapping['version'] is None and pl_module.hparams.external_mapping[
            #     'version'] is None:
            #     pass
            # else:
            ...
            #     extra_vis_save_root = os.path.join(output_dir, f'extra_vis_{stage}',
            #                                        'epoch_' + str(pl_module.current_epoch))
