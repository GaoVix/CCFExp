...
def main():
    ...
    model_hparam['recognition']['ckpt_path'] = os.path.join(root, os.path.join(root, os.path.join(*model_hparam['recognition']['ckpt_path'].split(os.sep)[4:])))
    ...
    model_hparam['id_model']['ckpt_path'] = os.path.join(root, os.path.join(root, os.path.join(*model_hparam['id_model']['ckpt_path'].split(os.sep)[4:])))
    model_hparam['face_model']['ckpt_path'] = os.path.join(root, os.path.join(root, os.path.join(*model_hparam['face_model']['ckpt_path'].split(os.sep)[4:])))
    model_hparam['_target_'] = 'src.trainer.Trainer'
    model_hparam['lm_detector_path'] = os.path.join(root, os.path.join(root, os.path.join(*model_hparam['lm_detector_path'].split(os.sep)[4:])))
    model_hparam['_partial_'] = True
    # model_hparam['ckpt_path'] = ''
    model_hparam['ckpt_path'] = os.path.join(root, os.path.join(root, os.path.join(*model_hparam['ckpt_path'].split(os.sep)[4:])))
